...
public class ConfigXML {
	...
	private ConfigXML() {
		...
		try {
			...
			// System.out.println("Opening config.xml:
			// "+getClass().getClassLoader().getResource("../resources/config.xml").getFile());
			// Document doc = dBuilder.parse(new
			// File(getClass().getClassLoader().getResource("../resources/config.xml").getFile()));
