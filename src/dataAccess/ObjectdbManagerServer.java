	...
	public ObjectdbManagerServer() {
				...
				okButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						try {
							...
							try {
								Runtime.getRuntime().exec("java -cp lib\\objectdb.jar com.objectdb.Server -port "
		...
		if (c.isDatabaseLocal()) {
			...
			try {
				...
				try {
					Runtime.getRuntime().exec("java -cp resources\\objectdb.jar com.objectdb.Server -port "
