...
public class SetAvailabilityGUI extends JFrame {
	...
	public SetAvailabilityGUI(byte userType, String username, Vector<RuralHouse> v) {
	...
	private void jButton1_actionPerformed(ActionEvent e) {
		...
		// The next instruction creates a java.util.Date object from the date
		...
		try {
			...
			if (o == null) {
				...
				jLabel5.setText(ResourceBundle.getBundle("Etiquetas").getString("OfferCreated"));
			}

		} catch (java.lang.NumberFormatException e1) {
			jLabel5.setText(
					jTextField3.getText() + " " + ResourceBundle.getBundle("Etiquetas").getString("PriceNotValid"));
